...
<input type="text" name="libelle"></td>
<td><label for="prix">prix journalier</label>
<input type="prix" name="prix"></td>

<td><label for="etat"> Etat de salle</label>
...
<td>
<button class="btn-next" >Enregistre</button>
</td>
</tr>
...
export class ModfsalleComponent {
